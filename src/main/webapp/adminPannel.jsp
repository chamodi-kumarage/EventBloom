...
<body>
    ...
    <div class="notification-panel" id="notificationPanel">
        ...
        <ul id="notificationList">
            <li><strong>New User:</strong> A new event planner has registered.</li>
            <li><strong>Event Request:</strong> A client requested a wedding package.</li>
            <li><strong>System Update:</strong> Version 2.1 has been deployed.</li>
            <li><strong>Payment Alert:</strong> Invoice #2094 pending approval.</li>
            <li><strong>Moderator Message:</strong> Feedback submitted on recent event.</li>
        </ul>
    </div>
